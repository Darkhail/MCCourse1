package net.darkhail.mccourse.screen;

import com.mojang.blaze3d.systems.RenderSystem;
import net.darkhail.mccourse.MCCourseMod;
import net.darkhail.mccourse.screen.renderer.EnergyDisplayTooltipArea;
import net.darkhail.mccourse.screen.renderer.FluidTankRenderer;
import net.darkhail.mccourse.util.MouseUtil;
