package net.darkhail.mccourse.worldgen;

import net.darkhail.mccourse.MCCourseMod;
import net.darkhail.mccourse.block.ModBlocks;
import net.darkhail.mccourse.worldgen.tree.custom.WalnutFoliagePlacer;
import net.darkhail.mccourse.worldgen.tree.custom.WalnutTrunkPlacer;
